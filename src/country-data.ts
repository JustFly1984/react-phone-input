...
const rawAllCountries: RawCountries = [
  [
    'Afghanistan',
    ['asia'],
    'af',
...
export let allCountryCodes: { [key: string]: string[] } = {}

function addCountryCode (iso2: string, dialCode: string, priority?: number): void {
...
function generateCountry (country: RawCountry): Country[] {
  ...
  if (country[6]) {
    country[6].forEach(function forEach (areaCode: string): void {
...
export const allCountries = rawAllCountries.reduce<Country[]>(function reducer (acc, item): Country[] {
